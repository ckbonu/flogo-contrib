...
// AzureIoT is an Activity that is used to update an Azure IoT device shadow
...
func NewActivity(metadata *activity.Metadata) activity.Activity {
	return &AwzureIoT{metadata: metadata}
}
...
func (a *AzureIoT) Eval(context activity.Context) (done bool, err error) {
	...
	thingUpdate := fmt.Sprintf("$azure/things/%s/shadow/update", thingName)
...
// ShadowRequest is a simple structure representing a Azure Shadow Update Request
